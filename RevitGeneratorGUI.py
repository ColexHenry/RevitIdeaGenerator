...
#Creates Labels for Welcome Messages
Label(root, text="Welcome to the Revit Building Idea Generator").place(x = 120, y = 20) 
Label(root, text="Click the button to generate Revit Building Ideas!").place(x = 90, y = 70) 


#Creates Function named Main which contains the logic for the program
def main():
...
main()
Button(root, text="Generate Building Idea", command=main, highlightcolor='green').place(x = 80, y = 320) # Button to generate new building idea
Button(root, text="Quit", command=root.destroy, highlightcolor='red').place(x = 350, y = 320) #button for quitting program
